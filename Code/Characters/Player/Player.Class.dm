...
/data/hud/New()
	...
	l_hand = new("[HANDS_OFFSET]:16,1:8","L Hand")
	r_hand = new("[HANDS_OFFSET+1]:16,1:8","R Hand")
	drop = new("[HANDS_OFFSET]:16,2:8")
	swap = new("[HANDS_OFFSET+1]:16,2:8")
	...
	hit = new("[HANDS_OFFSET]:8, 3:8")
	stand = new("[HANDS_OFFSET+1]:8, 3:8")
