...
var/list
	...
	". (B)'s (SHIELD) guards (BN) from the attack."
	)
...
fight
	...
	proc/NextTurn(n=5)
		...
		if(print_combat)
			...
			attack_message = dd_replacetext(attack_message, "(BN)", defense.gender==MALE?"him":"her")
